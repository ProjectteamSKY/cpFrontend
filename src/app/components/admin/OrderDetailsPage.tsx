    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="flex gap-2 overflow-x-auto">
                {[
                  ...
                  <button
                    ...
                    className={`px-4 py-2 rounded-lg transition-all flex items-center gap-2 whitespace-nowrap ${activeSection === section.id
                        ...
                        <div className="flex-1">
                          ...
                          <div className="grid grid-cols-2 gap-2 mb-3 text-sm">
                            ...
                            <div>
                              ...
                              <span className="ml-2 font-medium text-blue-600">{formatCurrency(item.total_price)}</span>
                            </div>
                          </div>
                ...
                <div className="bg-white rounded-lg shadow-sm p-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between py-3 border-t-2">
                      ...
                      <span className="font-bold text-xl text-blue-600">{formatCurrency(order.total_amount || 0)}</span>
                    </div>
                  </div>
                </div>
          ...
          <div className="space-y-6">
            {/* Order Summary Card */}
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg shadow-sm p-6 sticky top-24">
              ...
              <div className="space-y-3">
                ...
                {order.shipment?.awb_code && (
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-mono text-xs">{order.shipment.awb_code}</span>
                  </div>
                )}
              </div>
              ...
              <div className="mt-4 pt-4 border-t border-gray-200">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-2xl font-bold text-blue-600">{formatCurrency(order.total_amount || 0)}</span>
                </div>
              </div>
            </div>
          </div>
